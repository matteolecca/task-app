...
const Input = props => {
    ...
    const disabledStyle = disabled ? classes.disabled : null
    return (
        <div className={[classes.InputContainer, padding, disabledStyle].join(' ')}>
        {props.children}
        <input 
        ref={ focused  ? input => input && input.focus() : null}
